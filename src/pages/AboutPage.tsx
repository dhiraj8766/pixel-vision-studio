      ...
      <div className="relative z-10">
        ...
        <div className="mx-auto max-w-3xl mb-12 sm:mb-20">
          <div className="grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-4">
            {stats.map((stat, i) => (
              <div key={i} className="rounded-xl sm:rounded-2xl border border-border bg-card p-4 sm:p-6 text-center transition-all hover:border-primary/20 hover:shadow-glow">
        ...
        <div className="mx-auto max-w-4xl mb-12 sm:mb-20 grid gap-4 sm:gap-8 md:grid-cols-2">
          <div className="rounded-xl sm:rounded-2xl border border-border bg-card p-5 sm:p-8">
          ...
          <div className="rounded-xl sm:rounded-2xl border border-primary/20 bg-gradient-to-br from-card to-secondary p-5 sm:p-8">
        ...
        <div className="mx-auto max-w-4xl mb-12 sm:mb-20">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-4">
            {values.map((v, i) => (
              <div key={i} className="rounded-lg sm:rounded-xl border border-border bg-card/50 p-3 sm:p-5 text-center transition-all hover:border-primary/20">
